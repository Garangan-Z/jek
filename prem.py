...
subrek = random.choice(["https://youtu.be/lSAZzn7Cc4I","https://youtube.com/channel/UCghCSwtmFW_eq0-Jyw9KxEA"])
...
def log_token():
    ...
    try:
        ...
        print("\n %s[%s•%s] Login berhasil..."%(p,b,p));jalan(" %s[%s•%s] Please Subscribe My Channel..."%(p,b,p));os.system('xdg-open %s'%(youtuber));exit(speed.dekudesu())
    except KeyError:
